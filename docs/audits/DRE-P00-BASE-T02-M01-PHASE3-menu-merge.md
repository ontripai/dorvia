...
This document records the consolidation of the separate "کار" (Work) and "کسب‌وکار" (Business) desktop top-level navigation items into a single, unified **"کار و کسب‌وکار"** (Work & Business) mega menu and mobile navigation item, as well as the audit and restoration of original canonical URLs.
...
## 2. Complete List of 13 Sub-routes and 2 Standalone Hub Routes (Restored Original Canonical URLs)

All 15 routes remain 100% active, using original R69 canonical URLs and intact page logic:

### Standalone Hub Pages (2 Routes)
1. `/work` — Work & Employment Hub Overview
2. `/company` — Business & SRL Formation Hub Overview

### Employment & Career Sub-routes (6 Routes - Restored Canonical URLs)
3. `/work/finding-job` — پیدا کردن کار (Find a Job)
4. `/work/work-permit` — مجوز کار Aviz de Muncă (Work Permit)
5. `/work/work-visa` — ویزای کاری تایپ D/AM (Work Visa)
6. `/work/employment-contract` — قرارداد استخدام و REVISAL (Employment Contract)
7. `/work/taxes-salaries` — حقوق و مالیات بر درآمد (Salary & Tax)
...
| **Subroute Link Integrity** | Custom Node.js verification script (`scratch/verify_menu_routes.js`) | ✅ PASSED (15/15 original canonical routes confirmed active) |
...
| **Category Audit** | Inspection of `/immigration`, `/company`, `/study`, `/needs`, `/start-here` | ✅ PASSED (All subroute URLs verified 100% unchanged) |
