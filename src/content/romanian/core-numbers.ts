...
export const CORE_NUMBERS: RomanianWord[] = [
  ...
  // =========================================================================
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/o%20sut%C4%83',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/o%20mie',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  // =========================================================================
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DOOM 3)',
      url: 'https://dexonline.ro/definitie/primul',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DOOM 3)',
      url: 'https://dexonline.ro/definitie/prima',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/al%20doilea',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/a%20doua',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/a%20patra',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/a%20cincea',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/a%20opta',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/a%20noua',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DEX \'09)',
      url: 'https://dexonline.ro/definitie/a%20zecea',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
  ...
  },
  {
    ...
    source: {
      kind: 'common-usage',
      label: 'dexonline — definitie (DOOM 3)',
      url: 'https://dexonline.ro/definitie/%C3%AEnt%C3%A2ia',
      retrievedAt: '2026-09-24',
    },
    reviewer: 'ai-only',
    status: 'draft',
