          ...
          <div className="mt-12 bg-[#F8FAFC] rounded-2xl p-6 sm:p-8 border border-[#e2e8f0]">
            ...
            <div className="space-y-6">
              ...
              <div id="srl-vs-pfa">
                ...
                <p className="text-sm text-[#475569]">{currentLang === 'fa' ? 'باید به سه تمایز کلیدی توجه کنید: ۱. محدودیت ملیت: بر اساس بررسی ما، طبق ماده ۳(۱) فرمان اضطراری OUG 44/2008، ثبت PFA به اتباع رومانی، کشورهای عضو اتحادیه اروپا (EU) و منطقه اقتصادی اروپا (EEA) محدود است. بنابراین PFA عموماً برای شهروندان ایرانی در دسترس نیست مگر دارندگان اقامت دائم/بلندمدت اتحادیه اروپا یا وضعیت حقوقی ویژه؛ برای اکثر اتباع غیر اتحادیه اروپا مسیر عملیاتی ثبت SRL است. ۲. مسئولیت مالی: در SRL مسئولیت سهامداران محدود به سرمایه ثبتی شرکت است و دارایی شخصی مصون می‌ماند؛ در PFA مسئولیت نامحدود است و تمام دارایی شخصی و خانوادگی پاسخگوی بدهی‌هاست. ۳. بار اداری: PFA ثبت و حسابداری ساده‌تری دارد اما محدودیت مقیاس دارد؛ SRL نیاز به حسابداری دوبل رسمی تحت نظارت حسابدار عضو CECCAR دارد اما امکان استخدام نامحدود، اعتبار تجاری بالاتر و انعطاف‌پذیری کامل برای فعالیت بین‌المللی فراهم می‌کند.' : 'You should consider three key distinctions: 1. Nationality restriction: Based on our review, Article 3(1) of Emergency Ordinance OUG 44/2008 restricts PFA registration to citizens of Romania, EU member states, and the European Economic Area (EEA). Consequently, a PFA is generally not accessible to Iranian nationals unless they hold EU long-term residency or equivalent legal status; for most non-EU nationals the viable practical route is an SRL. 2. Financial liability: In an SRL, shareholder liability is strictly limited to registered share capital, shielding personal assets; in a PFA, liability is unlimited, placing personal and family assets at risk for business debts. 3. Administrative burden: A PFA has simpler bookkeeping but scalability limits; an SRL requires formal double-entry accounting managed by a CECCAR accountant, but provides unlimited hiring ability, higher commercial credibility, and full flexibility for international operations.'}</p>
              </div>
              <div>
