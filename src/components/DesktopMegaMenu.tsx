          ...
          <div className="grid grid-cols-12 gap-8 text-xs">
            ...
            <div className="col-span-4 space-y-3">
              ...
              <ul className="space-y-2 text-[#526174] font-medium">
                ...
                <li><Link href="/needs/flights-travel" className="hover:text-[#2F6FED] py-1 cursor-pointer" onClick={onClose}>✈️ {currentLang === 'fa' ? 'سفر و بلیط هوایی به رومانی' : 'Flights & Travel to Romania'}</Link></li>
              </ul>
            </div>
