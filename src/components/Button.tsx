...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses: Record<ButtonVariant, string> = {
    primary: "border-0 bg-[#0038a8] hover:bg-[#081f3f] text-white focus:ring-[#0038a8] shadow-xs hover:-translate-y-0.5",
    accent: "border-0 bg-[#fcd116] hover:bg-yellow-400 text-[#06162d] font-extrabold focus:ring-[#fcd116] shadow-sm hover:-translate-y-0.5",
    ...
    ghost: "border-0 bg-transparent hover:bg-[#eef3f8] text-[#0038a8] focus:ring-[#0038a8]",
    danger: "border-0 bg-[#ce1126] hover:bg-[#a50f20] text-white focus:ring-[#ce1126]"
  };
