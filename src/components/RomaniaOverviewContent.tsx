      ...
      return (
        <div className="space-y-10 animate-fadeIn max-w-[1280px] mx-auto px-4 py-8">
          ...
          <div className="prose prose-slate max-w-none text-[#526174] text-sm sm:text-base leading-relaxed bg-white p-6 sm:p-8 rounded-2xl border border-[#dfe6ef] shadow-sm">
            {currentLang === 'fa'
              ? 'رومانی از سال ۲۰۰۷ عضو کامل اتحادیه اروپا است و از ژانویه ۲۰۲۵ (پس از رفع کنترل مرزی هوایی و دریایی در مارس ۲۰۲۴) به‌طور کامل به فضای شنگن پیوسته است؛ یعنی دیگر هیچ کنترل مرزی داخلی شنگن (زمینی، هوایی یا دریایی) روی مرزهای رومانی وجود ندارد. با این حال، رومانی هنوز یورو را نپذیرفته و واحد پول رسمی همچنان لئوی رومانی (RON) است؛ در ۲۳ اوت ۲۰۲۶ وزیر دارایی موقت رومانی سال ۲۰۳۲ را به‌عنوان هدف جدید پیوستن به یورو مطرح کرد، اما این تاریخ صراحتاً مشروط به تثبیت مالی تا ۲۰۳۰ و ثبات سیاسی است؛ رئیس بانک مرکزی رومانی (BNR) محتاط‌تر بوده و گفته «در حال حاضر تدوین برنامه زمانی واقع‌بینانه ممکن نیست» چون رومانی هنوز هیچ‌کدام از معیارهای همگرایی یورو را احراز نکرده. رومانی پیش‌تر هم چند بار تاریخ هدف پیوستن به یورو را عقب انداخته (ابتدا ۲۰۱۹، سپس ۲۰۲۹) — پس تاریخ ۲۰۳۲ را باید به‌عنوان یک هدف سیاسی و نه یک قطعیت در نظر گرفت.'
              : 'Romania has been a full EU member since 2007 and, as of January 2025 (following the March 2024 lifting of air/sea checks), is a full Schengen Area member — meaning no internal Schengen border checks (land, air, or sea) remain at Romania\'s borders. Romania has not yet adopted the euro, however; the official currency remains the Romanian Leu (RON). On August 23, 2026 Romania\'s interim finance minister floated 2032 as a new euro-adoption target, but explicitly conditional on fiscal consolidation by 2030 and political stability; the BNR governor has been more cautious, saying "it is not currently possible to set a realistic timeline" since Romania still meets none of the formal convergence criteria. Romania has repeatedly pushed back its euro target before (first 2019, then 2029) — so treat 2032 as a political aspiration, not a certainty.'}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="editorial-card p-6 bg-white border border-[#dfe6ef] space-y-4">
              ...
              <ul className="space-y-2 text-sm text-[#526174] list-disc list-inside">
                <li>{currentLang === 'fa' ? 'حداقل دستمزد ناخالص ملی از ۱ ژوئیه ۲۰۲۶ (طبق تصمیم دولت شماره ۱۴۶/۲۰۲۶) برابر ۴,۳۲۵ لئو در ماه است (افزایش از ۴,۰۵۰ لئو).' : 'The national gross minimum wage has been RON 4,325/month since July 1, 2026 (per Government Decision 146/2026, up from RON 4,050).'}</li>
                <li>{currentLang === 'fa' ? 'طبق مؤسسه ملی آمار (INS، اعلام‌شده ۱۲ اوت ۲۰۲۶)، میانگین دستمزد خالص ماهانه در سراسر کشور در ژوئن ۲۰۲۶ برابر ۵,۷۳۴ لئو (حدود ۱,۰۹۴ یورو) بوده، با رشد ۳.۵٪ نسبت به سال قبل؛ این رقم بین شهرها و مشاغل تفاوت زیادی دارد، به‌ویژه در بخش فناوری اطلاعات که معمولاً بالاتر از میانگین ملی است.' : 'Per the National Institute of Statistics (INS, released August 12, 2026), the nationwide average monthly net salary in June 2026 was RON 5,734 (about €1,094), up 3.5% year-on-year; this varies significantly by city and profession, particularly in IT, which typically pays well above the national average.'}</li>
            ...
            <div className="editorial-card p-6 bg-white border border-[#dfe6ef] space-y-4">
              <h3 className="text-lg font-bold text-[#142033] flex items-center space-x-2 rtl:space-x-reverse">
                ...
                <span>{currentLang === 'fa' ? 'شاخص‌های کلان اقتصادی' : 'Key Macroeconomic Indicators'}</span>
              </h3>
              <ul className="space-y-2 text-sm text-[#526174] list-disc list-inside">
                <li>{currentLang === 'fa' ? 'تولید ناخالص داخلی (GDP) رومانی حدود ۴۲۸.۷ میلیارد دلار (۲۰۲۵) با سرانه حدود ۱۲,۵۶۵ دلار است (منبع: بانک جهانی، از طریق Trading Economics).' : 'Romania\'s GDP was approximately $428.7 billion USD in 2025, with GDP per capita around $12,565 (source: World Bank, via Trading Economics).'}</li>
                <li>{currentLang === 'fa' ? 'نرخ بیکاری در ژوئیه ۲۰۲۶ به ۶.۴٪ رسید — کاهش ۰.۴ واحد درصد نسبت به رقم ژوئن ۲۰۲۶ که بعداً به ۶.۸٪ تجدیدنظر شد (رقم اولیه اعلام‌شده برای ژوئن ۶.۳٪ بود)، طبق اعلام اداره ملی آمار رومانی (INS) در ۱ سپتامبر ۲۰۲۶.' : "Romania's unemployment rate fell to 6.4% in July 2026, down 0.4 percentage points from June 2026's figure, which was later revised upward to 6.8% (the initially reported June figure was 6.3%), per Romania's National Statistics Institute (INS), announced September 1, 2026."}</li>
                <li>{currentLang === 'fa' ? 'نرخ تورم سالانه در ژوئیه ۲۰۲۶ برابر ۸.۲٪ بوده (کاهش از ۹.۲٪ در ژوئن) — این رقم بالاترین نرخ تورم در کل اتحادیه اروپا است (میانگین اتحادیه حدود ۳٪)، طبق داده یوروستات منتشرشده ۱۹ اوت ۲۰۲۶.' : 'Annual inflation was 8.2% in July 2026 (down from 9.2% in June) — the highest rate in the entire EU (EU average is around 3%), per Eurostat data published August 19, 2026.'}</li>
                <li>{currentLang === 'fa' ? 'برای برنامه‌ریزی مالی، این نرخ تورم بالا به‌معنای کاهش سریع‌تر ارزش پس‌انداز لئویی نسبت به میانگین اروپاست؛ در نظر گرفتن آن مهم است.' : 'For financial planning: this above-average inflation rate means RON savings lose purchasing power faster than the EU average — worth factoring into long-term planning.'}</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-12 bg-[#F8FAFC] rounded-2xl p-6 sm:p-8 border border-[#e2e8f0]">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h4 className="font-bold text-[#334155] mb-2">{currentLang === 'fa' ? 'آیا هزینه زندگی در رومانی رو به افزایش است؟' : 'Is the cost of living in Romania rising?'}</h4>
                <p className="text-sm text-[#475569]">{currentLang === 'fa' ? 'بله، به‌طور محسوس. نرخ تورم رومانی (۸.۲٪ در ژوئیه ۲۰۲۶) بالاترین نرخ در کل اتحادیه اروپاست، هرچند میانگین حقوق هم رشد داشته (حدود ۳.۵٪ نسبت به سال قبل). برای برنامه‌ریزی مالی بلندمدت (اجاره، قرارداد کار)، بهتر است این شکاف را در نظر بگیرید.' : 'Yes, noticeably. Romania\'s inflation rate (8.2% in July 2026) is the highest in the entire EU, though average wages have also grown (about 3.5% year-on-year). For long-term financial planning (rent, employment contracts), it\'s worth factoring in this gap.'}</p>
              </div>
            </div>
          </div>
