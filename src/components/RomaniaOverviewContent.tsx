          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="editorial-card p-6 bg-white border border-[#dfe6ef] space-y-4">
              ...
              <ul className="space-y-2 text-sm text-[#526174] list-disc list-inside">
                ...
                <li>{currentLang === 'fa' ? 'نرخ بیکاری در ژوئن ۲۰۲۶ برابر ۶.۳٪ بوده (کاهش جزئی نسبت به ماه قبل)، طبق اعلام INS در ۳۰ ژوئیه ۲۰۲۶.' : 'The unemployment rate was 6.3% in June 2026 (a slight decrease from the prior month), per INS data released July 30, 2026.'}</li>
