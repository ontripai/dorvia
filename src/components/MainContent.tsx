...
const NeedsContent = dynamic(() => import('./NeedsContent').then(m => m.NeedsContent), { ssr: false });
const RomaniaOverviewContent = dynamic(() => import('./RomaniaOverviewContent').then(m => m.RomaniaOverviewContent), { ssr: false });
const UniversitiesPage = dynamic(() => import('@/app/[lang]/universities/page'), { ssr: false });
const WorkOverviewContent = dynamic(() => import('./WorkOverviewContent').then(m => m.WorkOverviewContent), { ssr: false });
const StartHereContent = dynamic(() => import('./StartHereContent').then(m => m.StartHereContent), { ssr: false });
const IgiProcessContent = dynamic(() => import('./IgiProcessContent').then(m => m.IgiProcessContent), { ssr: false });
const PreparatoryYearContent = dynamic(() => import('./PreparatoryYearContent').then(m => m.PreparatoryYearContent), { ssr: false });
const StudyDetailsContent = dynamic(() => import('./StudyDetailsContent').then(m => m.StudyDetailsContent), { ssr: false });
const CompanyOverviewContent = dynamic(() => import('./CompanyOverviewContent').then(m => m.CompanyOverviewContent), { ssr: false });
const ImmigrationOverviewContent = dynamic(() => import('./ImmigrationOverviewContent').then(m => m.ImmigrationOverviewContent), { ssr: false });
const ScholarshipOverviewContent = dynamic(() => import('./ScholarshipOverviewContent').then(m => m.ScholarshipOverviewContent), { ssr: false });
const InvestmentOverviewContent = dynamic(() => import('./InvestmentOverviewContent').then(m => m.InvestmentOverviewContent), { ssr: false });
const ArticlesPage = dynamic(() => import('@/app/[lang]/articles/page'), { ssr: false });
...
const TrustSection = dynamic(() => import('./TrustSection').then(m => m.TrustSection), { ssr: true });
const AudienceSelector = dynamic(() => import('./AudienceSelector').then(m => m.AudienceSelector), { ssr: true });
const ProcessTimeline = dynamic(() => import('./ProcessTimeline').then(m => m.ProcessTimeline), { ssr: true });
const FAQAccordion = dynamic(() => import('./FAQAccordion').then(m => m.FAQAccordion), { ssr: true });
const OfficialResourceCard = dynamic(() => import('./OfficialResourceCard').then(m => m.OfficialResourceCard), { ssr: true });
            ...
            <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-7 space-y-6 text-center lg:text-start">
                  ...
                  {/* Assessment Trust Note (clarifies time / document sensitivity / result speed) */}
                  <div className="pt-1 flex flex-wrap items-center justify-center lg:justify-start gap-x-3 gap-y-1 text-[11px] sm:text-xs text-slate-300 font-semibold">
                    <span className="inline-flex items-center gap-1">⏱ {currentLang === 'fa' ? 'حدود ۳ دقیقه' : 'About 3 minutes'}</span>
                    <span className="text-slate-500" aria-hidden="true">•</span>
                    <span className="inline-flex items-center gap-1">🔒 {currentLang === 'fa' ? 'بدون نیاز به مدارک حساس' : 'No sensitive documents required'}</span>
                    <span className="text-slate-500" aria-hidden="true">•</span>
          ...
          <section className="py-20 bg-white">
            <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 border-b border-[#dfe6ef] pb-4">
                <div className="space-y-2">
                  <span className="text-[#1554bd] font-extrabold text-xs uppercase tracking-wider">
        ...
        <div className="space-y-12 animate-fadeIn max-w-[1280px] mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="editorial-card p-6 space-y-3 bg-white">
              <h3 className="text-lg font-bold text-[#1554bd]">🎓 {t.pathways.study.title}</h3>
            ...
            <div className="editorial-card p-6 space-y-3 bg-white">
              <h3 className="text-lg font-bold text-[#1554bd]">💼 {t.pathways.work.title}</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <Link href="/universities" className="editorial-card p-5 bg-white border border-[#dfe6ef] rounded-2xl hover:border-[#2F6FED] transition-all cursor-pointer flex flex-col justify-between">
                ...
                <span className="text-xs font-bold text-[#1554bd] pt-3 inline-block">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 sm:p-8 rounded-2xl border border-blue-100 space-y-4">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-[#526174]">
              <div className="flex items-start space-x-2 rtl:space-x-reverse">
                <span className="text-[#1554bd] font-bold">▪</span>
                <span>
                  {currentLang === 'fa' ? 'هنوز دانشگاه و رشته مورد نظر خود را انتخاب نکرده‌اید؟ ' : 'Have not selected a university yet? '}
                  <Link href="/universities" className="text-[#1554bd] font-bold hover:underline">
              ...
              <div className="flex items-start space-x-2 rtl:space-x-reverse">
                ...
                <span>
                  ...
                  <Link href="/study/scholarships" className="text-[#1554bd] font-bold hover:underline">
              ...
              <div className="flex items-start space-x-2 rtl:space-x-reverse">
                ...
                <span>
                  ...
                  <Link href="/study/visa-type-d" className="text-[#1554bd] font-bold hover:underline">
              ...
              <div className="editorial-card p-6 space-y-4 bg-white">
                ...
                <ul className="space-y-2 text-xs sm:text-sm text-[#526174]">
                  <li className="flex items-center space-x-2 rtl:space-x-reverse">
                    <span className="w-4 h-4 rounded-full bg-blue-100 text-[#1554bd] flex items-center justify-center text-[10px] font-bold">✓</span>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <Link href="/study/scholarships" className="editorial-card p-4 space-y-2 bg-white cursor-pointer hover:border-[#2F6FED] transition-colors" >
                    <h4 className="font-bold text-[#1554bd]">{currentLang === 'fa' ? 'بورسیه تحصیلی دولتی' : 'Government Scholarships'}</h4>
                  ...
                  <Link href="/study/preparatory-year" className="editorial-card p-4 space-y-2 bg-white cursor-pointer hover:border-[#2F6FED] transition-colors" >
                    <h4 className="font-bold text-[#1554bd]">{currentLang === 'fa' ? 'سال زبان (پیش‌دانشگاهی)' : 'Language Preparatory Year'}</h4>
    ...
    case 'about':
      return (
        <div className="space-y-12 animate-fadeIn max-w-[1280px] mx-auto px-4 py-8">
          <div className="dark-hero-panel rounded-3xl p-8 sm:p-14 space-y-4 shadow-xl">
            <h1 className="text-3xl sm:text-5xl font-extrabold text-white">
              {currentLang === 'fa' ? 'درباره پلتفرم DORVIA EUROP' : 'About DORVIA EUROP'}
            </h1>
            <p className="text-slate-200 text-xs sm:text-sm max-w-3xl leading-relaxed">
              {t.brand.description}
            </p>
