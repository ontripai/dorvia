    ...
    <div className="space-y-10 animate-fadeIn max-w-[1280px] mx-auto px-4 py-8">
      ...
      <div className="bg-[#071B3D] text-white rounded-2xl p-6 sm:p-8 space-y-3">
        ...
        <p className="text-sm text-slate-300 leading-relaxed">
          {currentLang === 'fa'
            ? 'طبق صفحه رسمی برنامه (scholarships.studyinromania.gov.ro)، این بورسیه برای چرخه تحصیلی ۲۰۲۶-۲۰۲۷ فعال بوده و بازه ثبت‌نام آن ۱۶ فوریه تا ۳۱ مارس ۲۰۲۶ اعلام شده بود. یک نکته مهم که کمتر جایی به آن اشاره می‌شود: پوشش خوابگاه «یارانه‌دار» است، نه لزوماً کاملاً رایگان — یعنی دانشجوی بورسیه بخشی از هزینه خوابگاه را با نرخ تخفیف‌دار خودش می‌پردازد، نه صفر مطلق. مبلغ دقیق کمک‌هزینه ماهانه (Stipend) به‌صورت رسمی روی همان صفحه اعلام نشده — طبق مکانیزم قانونی، این مبلغ برابر با حداقل «بورس اجتماعی» (bursă socială) است که وزارت آموزش هرساله با دستور جداگانه برای دانشجویان رومانیایی تعیین می‌کند، نه یک رقم ثابت مستقل. برای سال تحصیلی ۲۰۲۵-۲۰۲۶، حداقل این مبلغ توسط دانشگاه فنی یاش (TUIASI) و رسانه‌های آموزشی رومانیایی ۹۲۵ لئو در ماه (یکسان برای کارشناسی، ارشد و دکتری) گزارش شده — این رقم از منبع دانشگاهی/رسانه‌ای است، نه مستقیماً از خودِ پلتفرم رسمی بورسیه، و چون هرساله تغییر می‌کند لزوماً برای چرخه ۲۰۲۶-۲۰۲۷ یکسان نیست؛ پیش از برنامه‌ریزی مالی حتماً از پلتفرم رسمی یا دانشگاه میزبان تایید بگیرید.'
            : 'Per the program\'s official page (scholarships.studyinromania.gov.ro), this scholarship was active for the 2026-2027 academic cycle, with an application window of February 16 to March 31, 2026. An important nuance rarely mentioned elsewhere: dormitory coverage is "subsidized," not necessarily fully free — the scholarship student still pays a discounted portion of the dorm fee, not zero. The exact monthly stipend amount is not published on that page itself — by the underlying legal mechanism, it equals the minimum "social scholarship" (bursă socială) rate the Ministry of Education sets annually for Romanian students, rather than a fixed standalone figure. For the 2025-2026 academic year, this minimum was reported at 925 RON/month (uniform across bachelor\'s, master\'s, and PhD levels) by Iași Technical University (TUIASI) and Romanian education press — this figure comes from a university/media source, not the scholarship platform itself, and since it resets annually it may not be identical for the 2026-2027 cycle; confirm with the official platform or your host university before financial planning.'}
        </p>
        <p className="text-[11px] text-slate-400">
          {currentLang === 'fa' ? 'منبع تاریخ‌ها: scholarships.studyinromania.gov.ro/scholarship-about — این تاریخ‌ها مخصوص یک چرخه هستند و هرساله تغییر می‌کنند؛ برای فراخوان جاری همیشه همان صفحه رسمی را چک کنید. منبع رقم کمک‌هزینه: international.tuiasi.ro (دانشگاه فنی یاش) و edupedu.ro (رسانه آموزشی)، بر پایه دستور وزارتی سالانه حداقل بورس اجتماعی.' : 'Source for dates: scholarships.studyinromania.gov.ro/scholarship-about — these dates are cycle-specific and change every year; always check that official page for the current call. Source for the stipend figure: international.tuiasi.ro (Iași Technical University) and edupedu.ro (education press), based on the Ministry\'s annual minimum social-scholarship order.'}
        </p>
